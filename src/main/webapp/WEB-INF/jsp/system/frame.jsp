...
<head>
    ...
    <script src="resource/system/js/frame.js"></script>
            ...
            <ul class="nav navbar-nav">
                            ...
                            <ul class="menu">
                                <li>
                                    ...
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="resource/superui/ui/img/photos/girl1.png" class="img-circle" alt="User Image">
                                        </div>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="resource/superui/ui/img/photos/girl1.png" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="resource/superui/ui/img/photos/girl1.png" class="img-circle" alt="用户头像">
            </div>
